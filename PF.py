...
def consejos():
    ...
    if a == 1:
        return "🌱 Reduce tu consumo de energía: Apaga luces y aparatos eléctricos cuando no los uses."
    elif a == 2:
        return "🚶‍♀️ Cambia tu forma de moverte: Usa el transporte público, bicicleta o camina siempre que puedas."
    elif a == 3:
        return "♻️ Reduce, reutiliza y recicla: Evita productos desechables: lleva tu botella, bolsas y tazas reutilizables."
    else:
        return "💡 Cuida el planeta de forma creativa. Siempre hay algo más que puedes hacer."
